...
namespace HolmiumOS.GUI
{
    public class Window
    {
        ...
        public void UpdateSize()
        {
            ...
            this.Width = calculatedWidth < minWidth
                ? minWidth
                : calculatedWidth;
        ...
        public void Draw(Canvas canvas)
        {
            ...
            canvas.DrawLine(
                Win9xDarkGray,
                minBtnX + 1,
                minBtnY + minBtnSize - 2,
                minBtnX + minBtnSize - 2,
                minBtnY + minBtnSize - 2
            );
        ...
        public void Drag(int mx, int my, Canvas canvas)
        {
            ...
            if (targetX + Width > screenWidth)
                targetX = screenWidth - Width;

            if (targetY < 0)
                targetY = 0;

            if (targetY + Height > screenHeight)
                targetY = screenHeight - Height;
