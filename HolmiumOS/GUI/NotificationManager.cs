    ...
    public static class NotificationManager
    {
        ...
        public static void Draw(Canvas canvas)
        {
            ...
            for (int i = 0; i < notifications.Count; i++)
            {
                ...
                canvas.DrawString(titleLine1, PCScreenFont.DefaultFont, Color.White, x + 20, y + 5);
                canvas.DrawString(msgLine1, PCScreenFont.DefaultFont, Color.Black, x + 8, y + 25);

                if (!string.IsNullOrEmpty(msgLine2))
                    canvas.DrawString(msgLine2, PCScreenFont.DefaultFont, Color.Black, x + 8, y + 42);
            }
        }

        public static void UpdateMouse(Canvas canvas)
        {
            bool isPressed = MouseManager.LeftButton;
