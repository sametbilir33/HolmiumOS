...
namespace HolmiumOS.GUI
{
    public static class TaskSwitcherManager
    {
        ...
        public static void Draw(Canvas canvas)
        {
            ...
            canvas.DrawString("Acik Uygulamalar", PCScreenFont.DefaultFont, Color.Black, boxX + 12, boxY + 10);
            ...
            for (int i = 0; i < visibleCount; i++)
            {
                ...
                canvas.DrawString(win.Title ?? "Uygulama", PCScreenFont.DefaultFont, i == selectedIndex ? Color.White : Color.Black, boxX + 14, itemY);
            }
        }
    }
}