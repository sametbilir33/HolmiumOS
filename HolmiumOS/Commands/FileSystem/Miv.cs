...
namespace HolmiumOS.Commands.FileSystem
{
    public class Miv : ICommand
    {
        ...
        public void Execute(string args)
        {
            ...
            {
                Console.WriteLine("Kullanim: miv <dosya>");
                return;
            }
        ...
        public static void printMIVStartScreen()
        {
            ...
            Console.WriteLine("~");
            Console.WriteLine("~");
            Console.WriteLine("~                        MIV - Minimalist Vi");
            Console.WriteLine("~");
            Console.WriteLine("~                             surum 1.2");
            Console.WriteLine("~                  Denis Bartashevich tarafindan gelistirildi");
            Console.WriteLine("~                    HolmiumOS icin duzenlenmistir");
            Console.WriteLine("~            MIV acik kaynaklidir ve ozgurce dagitilabilir");
            Console.WriteLine("~");
            Console.WriteLine("~          bilgi almak icin :help yazip <Enter>'a basin");
            Console.WriteLine("~          cikmak icin :q yazip <Enter>'a basin");
            Console.WriteLine("~          kaydedip cikmak icin :wq yazip <Enter>'a basin");
            Console.WriteLine("~          yazmaya baslamak icin i tusuna basin");
            Console.WriteLine("~");
            Console.WriteLine("~");
            Console.WriteLine("~");
            Console.WriteLine("~");
        ...
        public static void StartMIV(string file)
        {
            try
            {
                ...
                string text = miv(FileSystemManager.ReadFile(file));
