...
namespace HolmiumOS.Shell
{
    ...
    {
        private const string PasswdFile = @"/mnt/etc/passwd";
        private const string ShadowFile = @"/mnt/etc/shadow";

        public static string CurrentUser { get; private set; } = string.Empty;

        public static bool IsRoot =>
            CurrentUser.Equals("root", StringComparison.OrdinalIgnoreCase);

        public static bool IsLoggedIn =>
            !string.IsNullOrWhiteSpace(CurrentUser);

        public static string HomeDirectory =>
            $@"/mnt/home/{CurrentUser}";
        ...
        public static bool CreateUser(string username, string password)
        {
            ...
            Directory.CreateDirectory($@"/mnt/home/{username}");
            ...
            File.AppendAllText(
                ShadowFile,
                username + ":" + hash + Environment.NewLine);
            ...
            string newPassword)
        {
            ...
            foreach (string line in File.ReadAllLines(ShadowFile))
            {
                    ...
                    StringComparison.OrdinalIgnoreCase))
                {
                    lines.Add(
                        username + ":" +
                        PasswordHasher.CreateHash(newPassword));
            ...
            out string error)
        {
            ...
            foreach (char c in username)
            {
                ...
                {
                    error =
                        "Kullanici adi sadece a-z, 0-9, '_' " +
                        "ve '-' karakterlerini icerebilir.";
